...
[⬇ Download this section](https://raw.githubusercontent.com/{{ site.github_username }}/{{ site.github_repo }}/main/docs/obituary.md){: .btn }
...
An Obituary marks the death of a public figure with accuracy, respect, and authority. Its purpose is to serve as a reliable source of record on a significant event and to provide readers with a meaningful overview of the person's life and legacy.
