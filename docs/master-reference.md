...
Do **not** confuse with the Google Discover Explainer format (§3.1), which uses the `What Is [Topic]?` / `Who Is [Person]?` formula.
...
[H2 SECTION 1 — Google Trends keyword] — 80-word intro minimum
[H2 SECTION 2 — Google Trends keyword] — 80-word intro minimum
[H2 SECTION N — Google Trends keyword] — 80-word intro minimum
