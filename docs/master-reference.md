...
**REQUIRED** | Platform: Google Discover | Type: Explainer
...
### Dek
**REQUIRED** — CMS field only, not an in-article element
...
> ⚠️ **STUB** — This section is pending editorial leadership input. Do not populate until guidance is provided.

### 4.1 General Principles
*(To be completed)*

### 4.2 Approved Source Categories
*(To be completed)*

### 4.3 Prohibited Sources
*(To be completed)*

### 4.4 Source Verification Process
*(To be completed)*
