...
0. [x] ~~**Enter remaining 3 Team Target Audiences in CSA production**~~ — DONE (2026-04-15). All 5 National Team personas now live as shared Team Target Audiences in CSA production. Susannah entered The Discover Browser + The Wonder-Driven Science Enthusiast; Pierce entered The Curious Optimizer, The Curious Explorer, and The Watercooler Insider. Admin-only feature; environment-isolated. PGS-133 ON HOLD — admin workaround makes code-change ticket unnecessary.
